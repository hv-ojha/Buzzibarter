	...
	<?php include("includes/header.php");?>
			<div class="container content-wrapper">
				<div class="modal-header">
	                ...
	                <div class="col-lg-12">
                        <div class="top-part">
							<strong>Application Details</strong><i class="fa fa-edit"></i>
						</div>
                        <form class="edit-profile form-group" action="#" method="post">
						  ...
						  <div class="row">
                             <div class="form-group col-12">
                              <input name="app_name" type="text" class="form-control" placeholder="Application Name" required>
                          	 </div>
                          </div>
                          <div class="row">
						  	<div class="form-group col-12">
                              <input name="app_top" type="text" class="form-control" placeholder="Application Topic" required>
                          	</div>
                          </div>
                           <div class="row">
                             <div class="form-group col-12">
                                <textarea name="app_des" class="form-control" placeholder="Application Description" required></textarea>
                             </div>
                           </div>
                           <div class="row">
                            <div class="form-group col-12">
                                <input name="app_bid" type="text" class="form-control" placeholder="Starting Bid" required>
                            </div>
                           </div>
                           <div class="row">
                            <div class="form-group col-12">
                                <input name="last_date" type="date" class="form-control" placeholder="Last Date" required>
                            </div>
                           </div>
                           <div class="row">
                            <div class="form-group col-12">
                                <input name="api_key" type="text" class="form-control" placeholder="Google Play Store Link" required>
                            </div>
                           </div>
						  <div class="row">
                           	<div class="col-12">
                            	<button class="btn btn-info btn-block" name="app_upd" type="submit">Submit</button>
                            </div>
                           </div>
                        </form>
                    </div>
