    ...
    <div class="dashboard-content">
		<div class="holder">
			...
			<div class="my-listing">
				<h5><?php echo $row["website_topic"] ?></h5>
				...
				<div class="row">
					<div class="col-sm-3">
						<strong>Website Topic: &nbsp;</strong>
					</div>
					<div class="col-sm-6">
						<input type="text" name="web_top" value="<?php echo $row["website_topic"]; ?>">
					</div>
				</div>
                <div class="row">
					<div class="col-sm-3">
					...
					<div class="col-sm-6">
						<input type="text" name="web_domain" value="<?php echo $row["domain_name"]; ?>">
					</div>
				</div>
                <div class="row">
					<div class="col-sm-3">
					...
					<div class="col-sm-6">
						<input type="text" name="web_des" value="<?php echo $row["website_description"]; ?>">
					</div>
				</div>
                <div class="row">
					<div class="col-sm-3">
                ...
                <div class="row">
					...
					<div class="col-sm-6">
						<input type="date" name="web_last_date" value="<?php echo $row["last_date"]; ?>">
					</div>
				</div>
                <div class="row">
					<div class="col-sm-3">
					...
					<div class="col-sm-6">
						<input type="text" name="web_bid" value="<?php echo $row["starting_bid"]; ?>">
					</div>
				</div>
				<div class="row">
					<div class="col-sm-4">
						<input type="submit" name="upd_web" value="Update Website" class="btn ui-btn info text-light">
					</div>
				</div>
			</div>
		</div>
