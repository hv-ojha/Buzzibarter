		...
		<div class="holder">
            ...
            <div class="my-listing">
                <div class="row">
                    ...
                    {
                        $w1 = $r["domain_id"];
                        $bids = mysql_query("select * from bidding INNER JOIN listing ON bidding.listing_id=listing.listing_id INNER JOIN domains ON listing.pro_id=domains.domain_id INNER JOIN user ON bidding.user_id=user.user_id where listing_type='Domain_name' and domains.user_id=$id1 and domains.domain_id=$w1 and bidding.status='pending' order by amount DESC");
                        ...
                        <div class="row">
                            ...
                            ?>
                                <div class="short-div">
                                    <a href="short_listed_biddings.php?bid_id=<?php echo $row["bid_id"] ?>&web_id=<?php echo $row["domain_topic"] ?>" class="btn ui-btn btn-success text-light"> Accept </a>
                                </div>
                                <br>
                                <div class="short-div">
                                    <a class="btn ui-btn btn-info text-light"> Cancel </a>
                                </div>
                            <?php
                                }
                                else
        ...
        <div class="holder">
            ...
            <div class="my-listing">
                <div class="row">
                    ...
                    {
                        $w1 = $r1["website_id"];
                        $bids = mysql_query("select * from bidding INNER JOIN listing ON bidding.listing_id=listing.listing_id INNER JOIN website ON listing.pro_id=website.website_id INNER JOIN user ON bidding.user_id=user.user_id where listing_type='Website' and website.website_id=$w1 and website.user_id=$id1 and bidding.status='pending' order by amount DESC");
                        ...
                        <div class="row">
                            ...
                            ?>
                                <div class="short-div">
                                    <a href="short_listed_biddings.php?bid_id=<?php echo $row1["bid_id"] ?>&web_id=<?php echo $row1["website_topic"] ?>" class="btn ui-btn btn-success text-light"> Accept </a>
                                </div>
                                <br>
                                <div class="short-div">
                                    <a class="btn ui-btn btn-info text-light"> Cancel </a>
                ...
                <div class="row">
                    ...
                    while($r1 = mysql_fetch_array($app))
                    {
                        ...
                        <div class="row">
                            ...
                            ?>
                                <div class="short-div">
                                    <a href="short_listed_biddings.php?bid_id=<?php echo $row1["bid_id"] ?>&web_id=<?php echo $row1["application_topic"] ?>" class="btn ui-btn btn-success text-light"> Accept </a>
                                </div>
                                <br>
                                <div class="short-div">
                                    <a class="btn ui-btn btn-info text-light"> Cancel </a>
