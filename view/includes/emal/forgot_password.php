        ...
        <tr>
            <td>
                <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">
                    Forgot Password? Here's The link... 
                </div>
            </td>
        </tr>
    </table>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            <div style="line-height: 35px">
                                Reset Your <span style="color: #5caad2;">Password</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            As per Your Request it seems you forgot your password. Don't Panic We are here to help You out. Click on the below link to reset Password
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                        <div style="line-height: 26px;">
                                            <a href="localhost/client_php/view/forget_pwd.php?user_name=<?php echo $_REQUEST['uname'] ?>&pass=<?php echo $_REQUEST['pass'] ?>" style="color: #ffffff; text-decoration: none;">Verify Your E-Mail</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
