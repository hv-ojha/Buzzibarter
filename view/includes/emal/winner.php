        ...
        <tr>
            <td>
                <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">
                    Congratulations <?php echo $_GET["uname"] ?>...  
                </div>
            </td>
        </tr>
    </table>
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="https://assets-auctionnudge.s3.amazonaws.com/site/img/logo.png" alt="" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            <div style="line-height: 35px">
                                Congratulations <span style="color: #5caad2;"><?php echo $_REQUEST["uname"] ?></span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            Congratulations <?php echo $_GET["uname"] ?>.<br> Your Bid on <span style="color: #5caad2;"><?php echo $_GET["na"] ?></span> has been approved and declared as winner. For more detailed information visit your <a href="localhost/client_php/view/index.php">buzzibarter.com</a> and login with your registered account.<br> Keep Bidding on buzzibarter. Thank you.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                        <div style="line-height: 26px;">
                                            <a href="localhost/client_php/view/index.php" style="color: #ffffff; text-decoration: none;">Visit Website</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <td>
                            <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                <tr>
                                    <!-- logo -->
                                    <td align="left">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="https://assets-auctionnudge.s3.amazonaws.com/site/img/logo.png" alt="" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="25" style="font-size: 25px; line-height: 25px;">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            Email us: <br/> <a href="mailto:buzzibarter@gmail.com" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">buzzibarter@gmail.com</a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table border="0" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            <span style="color: #333333;">Visit Buzzibarter</span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
