...
<div class="slide-container">
    <div class="dashboard-content">
		<div class="holder">
			<div class="top-part"><strong>My Application</strong><i class="fa fa-list"></i></div>
			<?php
			...
			<div class="my-listing">
                <div class="row">
					<div class="col-sm-6">
						<div class="short-div">
							<h3><strong><?php echo $row["application_name"] ?><?php if($row["verified"]=="Verified"){ ?><i class="fa fa-check-circle-o text-success"></i><?php } else{ ?>
						...
						<div class="short-div">
							<strong>Application Topic: &nbsp;</strong><?php echo $row["application_topic"]; ?>
						</div>
						<div class="short-div">
					...
					<div class="col-8 btn-group-vertical  btn-group-lg">
						...
						{ ?>
							<a href="application.php?unpub=<?php echo $row["application_id"]; ?>" class="btn ui-btn btn-success"> <i class="fa fa-eye-slash text-light"> </i> Unpublish This Application</a>
						<?php
						}
						else 
						{
						?>
							<a href="application.php?pub=<?php echo $row["application_id"]; ?>" class="btn ui-btn btn-success"> <i class="fa fa-eye text-light"> </i> Publish This Application</a>
						<?php
						}
						?>
						<a href="website_update.php?app_id=<?php echo $row['application_id']; ?>" class="btn ui-btn btn-info"> <i class="fa fa-edit text-light"> </i> Update Application</a>
						<a href="#" class="btn ui-btn btn-danger"> <i class="fa fa-trash text-light"> </i> Delete Application</a>
						<a href="website_details.php?app_id=<?php echo $row["application_id"]; ?>" class="btn ui-btn btn-info"> <i class="fa fa-list text-light"> </i> View Full Details</a>
					</div>
					</div>
				</div>
            </div>
