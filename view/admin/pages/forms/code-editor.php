...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/forms/code-editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:21:49 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Code Editor </title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="advanced.html">Advanced Elements</a></li>
            <li><a href="editors.html">Editors</a></li>
            <li><a href="form-validation.html">Form Validation</a></li>
            <li><a href="form-wizard.html">Form Wizard</a></li>
            <li class="active"><a href="code-editor.html">Code Editor</a></li>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="card-title">Ace Editor (Javascript Mode)</h3>
          <h6 class="card-subtitle">You can find the <a href="https://github.com/ajaxorg/ace-builds" target="_blank">offical website </a></h6>
...
console.log(addResult);
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="card-title">Ace Editor (Html Mode And Emmet)</h3>
          <h6 class="card-subtitle">You can find the <a href="https://github.com/ajaxorg/ace-builds" target="_blank">offical website </a></h6>
...
&lt;/html>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="card-title">Ace Editor (Css Editor)</h3>
          <h6 class="card-subtitle">You can find the <a href="https://github.com/ajaxorg/ace-builds" target="_blank">offical website </a></h6>
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/forms/code-editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:21:50 GMT -->
</html>
