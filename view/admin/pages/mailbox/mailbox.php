...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/mailbox/mailbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:22:16 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  MailBox </title>
    ...
    <section class="content">
      <div class="row">
        <div class="col-lg-3 col-12">
          <a href="compose.html" class="btn btn-block btn-shadow margin-bottom btn-primary">Compose</a>
            ...
            <div class="box-body no-padding mailbox-nav">
              <ul class="nav nav-pills flex-column">
                <li class="nav-item"><a class="nav-link active" href="javascript:void(0)"><i class="ion ion-ios-email-outline"></i> Inbox
                  <span class="label pull-right label-danger">12</span></a></li>
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/mailbox/mailbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:22:19 GMT -->
</html>
