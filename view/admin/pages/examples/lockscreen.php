...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/examples/lockscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:27:15 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Lockscreen </title>
		...
		<form class="lockscreen-credentials form-element margin-top-20">
		  ...
		  <!-- /.col -->
			<div class="text-center">
			  <button type="submit" class="btn btn-block btn-flat margin-top-10 btn-primary">LOGIN</button>
			</div>
        <!-- /.col -->
		</form>
