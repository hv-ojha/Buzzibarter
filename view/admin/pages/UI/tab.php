...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/tab.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:19:35 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Tab  UI </title>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-lg-6">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="card-title">Default Tab</h3>
        ...
        <div class="col-md-12 col-lg-6">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="card-title">Customtab Tab</h3>
        ...
        <div class="col-md-12 col-lg-6">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="card-title">Tab with dropdown</h3>
              <h6 class="card-subtitle">Use default tab with class <code>nav-tabs & tabcontent-border</code></h6>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <div class="col-md-12 col-lg-6">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="card-title">Customtab2 Tab</h3>
              <h6 class="card-subtitle">Use default tab with class <code>customtab</code></h6>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <div class="col-md-12 col-lg-6">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="card-title">Nav Pills Tabs</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            	<!-- Nav tabs -->
        ...
        <div class="col-md-12 col-lg-6">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="card-title">Tab with icon</h3>
              <h6 class="card-subtitle">Use default tab with class <code>nav-tabs &amp; tabcontent-border </code></h6>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <div class="col-md-12 col-lg-6">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="card-title">Customtab vertical Tab Icon</h3>
              <h6 class="card-subtitle">Use default tab with class <code>vtabs & tabs-vertical</code></h6>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
