...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:20:21 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Button UI </title>
      ...
      <div class="row">
        <div class="col-12 col-xl-6">
          ...
          <div class="box">
            ...
            <div class="box-body res-tb-block  pad">
              <p>
          ...
          <div class="box">
            <div class="box-header">
              <h4 class="card-title">Social buttons Icon with Name</h4>
              <p>Use a classes <code>btn btn-social btn-bitbucket /  &lt; class="fa fa-bitbucket"&gt;&lt;/i&gt;</code> to quickly create a General btn.</p>
            </div>
            <div class="box-body demo-social">
              ...
              <div class="text-left margin-top-20">
                <h4 class="card-title">Social buttons Icon</h4>
