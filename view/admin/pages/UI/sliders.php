...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/sliders.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:20:21 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Range sliders and Carousel UI </title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="sliders.html">Sliders</a></li>
    ...
    <section class="content">
        ...
        <div class="col-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Bootstrap Range Slider</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
      ...
      <div class="row">
        <div class="col-lg-6 col-12">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Carousel Slider Only Slide</h3>
            </div>
            <div class="box-body">
        ...
        <div class="col-lg-6 col-12">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Carousel Slider with Controls</h3>
            </div>
            <div class="box-body">
      ...
      <div class="row">
        <div class="col-lg-6 col-12">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Carousel Slider with Indicators </h3>
            </div>
            <div class="box-body">
        ...
        <div class="col-lg-6 col-12">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Carousel Slider With captions</h3>
            </div>
            <div class="box-body">
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/sliders.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:21:16 GMT -->
</html>
