...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:21:17 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Modals UI </title>
    ...
    <section class="content">
				  ...
				  <div class="modal-dialog">
					<div class="modal-content">
					  ...
					  <div class="modal-footer">
						...
						<button type="button" class="btn btn-outline float-right">Save changes</button>
					  </div>
					</div>
					<!-- /.modal-content -->
				  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Small model <code>Click on image</code></h3>
            </div>
            <div class="box-body">
              <!-- sample modal content -->
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:21:28 GMT -->
</html>
