...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:19:56 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Notification </title>
            ...
            <div class="box-body">
              <div class="row">
					<div class="col-sm-3">
						...
						<button class="btn btn-default btn-outline showtop">Alert Top Full width</button>
						<!-- Start an Alert -->
            ...
            <div class="box-body">
              <div class="row">
					<div class="col-sm-3">
						...
						<!-- Start an Alert -->
						<div id="alerttopright" class="myadmin-alert myadmin-alert-img alert-info myadmin-alert-top-right"> <img src="../../images/avatar.png" class="img" alt="img"><a href="#" class="closed">&times;</a>
					...
					<div class="col-sm-3">
						...
						<!-- Start an Alert -->
						<div id="alerttopleft" class="myadmin-alert myadmin-alert-img alert-info myadmin-alert-top-left"> <img src="../../images/avatar2.png" class="img" alt="img"><a href="#" class="closed">&times;</a>
							<h4>You have a Message!</h4> <b>John Doe</b> sent you a message.</div>
					</div>
					<div class="col-sm-3">
						...
						<!-- Start an Alert -->
						<div id="alertbottomleft" class="myadmin-alert myadmin-alert-img alert-info myadmin-alert-bottom-left"> <img src="../../images/avatar3.png" class="img" alt="img"><a href="#" class="closed">&times;</a>
							<h4>You have a Message!</h4> <b>John Doe</b> sent you a message.</div>
					</div>
					<div class="col-sm-3">
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:20:19 GMT -->
</html>
