...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:18:03 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Cards UI </title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="cards.html">User Cards</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row fx-element-overlay">
       <div class="col-12"> 
       		<h2 class="card-title">Fade-in effect</h2>
       		<h6 class="card-subtitle margin-bottom">You can use by default <code>fx-overlay</code></h6>
       </div>
        <div class="col-md-12 col-lg-3">
          <div class="box box-default">
            <div class="fx-card-item">
				<div class="fx-card-avatar fx-overlay-1"> <img src="../../images/card/1.jpg" alt="user">
					<div class="fx-overlay">
						<ul class="fx-info">
							<li><a class="btn default btn-outline image-popup-vertical-fit" href="../plugins/images/users/1.html"><i class="ion-search"></i></a></li>
        ...
        <div class="col-md-12 col-lg-3">
          <div class="box box-default">
            <div class="fx-card-item">
				<div class="fx-card-avatar fx-overlay-1"> <img src="../../images/card/4.jpg" alt="user">
					<div class="fx-overlay">
						<ul class="fx-info">
							<li><a class="btn default btn-outline image-popup-vertical-fit" href="../plugins/images/users/1.html"><i class="ion-search"></i></a></li>
							<li><a class="btn default btn-outline" href="javascript:void(0);"><i class="ion-link"></i></a></li>
      ...
      <div class="row fx-element-overlay">
       <div class="col-12"> 
       		<h2 class="card-title">Scroll down effect</h2>
       		<h6 class="card-subtitle margin-bottom">You can use by default <code>fx-overlay scrl-dwn</code></h6>
       </div>
        <div class="col-md-12 col-lg-3">
          <div class="box box-default">
            <div class="fx-card-item">
      ...
      <div class="row fx-element-overlay">
       <div class="col-12"> 
       		<h2 class="card-title">Scroll up effect</h2>
       		<h6 class="card-subtitle margin-bottom">You can use by default <code>fx-overlay scrl-up</code></h6>
       </div>
        <div class="col-md-12 col-lg-3">
          <div class="box box-default">
            <div class="fx-card-item">
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/UI/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:19:35 GMT -->
</html>
