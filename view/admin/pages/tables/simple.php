...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/tables/simple.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:22:04 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Basic Tables </title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="simple.html">Simple tables</a></li>
            <li><a href="data.html">Data tables</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <div class="col-md-12 col-lg-6">
          <div class="box">
            <div class="box-header">
              ...
              <h6 class="box-subtitle">Add class <code>.table</code></h6>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/tables/simple.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:22:05 GMT -->
</html>
