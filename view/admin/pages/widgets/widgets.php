...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/widgets/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:15:16 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Apro Admin - Dashboard  Widgets</title>
        ...
        <div class="col-xl-3 col-lg-6 col-12">
          ...
          <div class="box box-primary direct-chat direct-chat-success">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
				<span data-toggle="tooltip" title="1 New Messages" class="badge bg-green">1</span>
				<button type="button" class="btn btn-box-tool" data-toggle="tooltip" title="Contacts" data-widget="chat-pane-toggle">
				  <i class="fa fa-comments"></i></button>
				<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
				</button>
        ...
        <div class="col-xl-6 col-lg-12">
          ...
          <div class="box box-widget">
            ...
            <div class="box-footer box-comments">
              ...
              <div class="box-comment">
                <!-- User image -->
                <img class="rounded img-sm" src="../../images/user5-128x128.jpg" alt="User Image">
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/widgets/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:15:25 GMT -->
</html>
