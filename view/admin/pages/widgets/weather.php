...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/widgets/weather.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:15:25 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
				...
				<div class="row">
     				<div class="col-6">
					  <div class="text-center p-45">
       				...
       				<!-- /.col -->
       				<div class="col-6">
					  <div class="text-center p-45" style="border-left: 1px solid rgba(255, 255, 255, 0.3);">
						<div class="vertical-align-middle">
						  <div class="font-size-40">
							<i class="wi-cloudy"></i>
						  </div>
     ...
     <div class="row">
       ...
       <div class="col-6">                         
      	 <!-- Default box -->
		  <div class="box text-center bg-blue">		
			<div class="box-body">
			  <div class="p-30">
				<div class="font-size-40">
				  <i class="wi-day-cloudy-windy"></i>
			...
			<!-- /.box-body -->				
		  	<div class="box-footer with-border bg-blue">
				<div class="row no-space">
				  <div class="col-6">
...
<!-- Mirrored from html-templates.multipurposethemes.com/bootstrap-4/admin/aproadmin-dark/pages/widgets/weather.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Jan 2018 12:16:43 GMT -->
</html>
