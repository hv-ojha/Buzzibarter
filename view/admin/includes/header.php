<header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Buzzibarter</b>Admin</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu scale-up">
              ...
              <li class="user-header">
                ...
                <p>
                <?php echo $res["adm_name"]; ?>
                  <small class="mb-5"><?php echo $res["email_id"]; ?></small>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="login.php?logout=1" class="btn btn-block btn-danger"><i class="ion ion-power"></i> Log Out</a>
                </div>
              </li>
            </ul>
          </li>
