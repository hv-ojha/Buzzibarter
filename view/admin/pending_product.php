...
$ob = new controller;
$web=$ob->website_not_verified_display();
$dom=$ob->dom_not_verified_display();
$app=$ob->app_not_verified_display();
if(isset($_REQUEST['table']) && $_REQUEST['table']=="website")
{
	$id=$_REQUEST['ver'];
	$ob->website_verify($id);
}
if(isset($_REQUEST['table']) && $_REQUEST['table']=="domains")
{
	$id=$_REQUEST['ver'];
	$ob->domain_verify($id);
}
if(isset($_REQUEST['table']) && $_REQUEST['table']=="application")
{
	$id=$_REQUEST['ver'];
	$ob->app_verify($id);
}
...
<head>
  <meta charset="utf-8">
    ...
    <title>Buzzibarter Admin - Pending Product </title>
        ...
        <div class="box-body" style="overflow-x:auto">
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-sm-4 border-right">
								<a href="bidding_details.php?web_id=<?php echo $row["website_id"]; ?>">
                  <div class="description-block">
                ...
                <!-- /.col -->
                <div class="col-sm-4">
								<a href="pending_product.php?ver=<?php echo $row['website_id']; ?>&table=website">
                  <div class="description-block">
                    <h5 class="description-header">Verify This Website</h5>
                  </div>
									</a>
                  <!-- /.description-block -->
                </div>
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-sm-4">
                <a href="pending_product.php?ver=<?php echo $row['domain_id']; ?>&table=domains">
                  <div class="description-block">
                    <h5 class="description-header">Verify This Domain</h5>
                  </div>
                  </a>
                  <!-- /.description-block -->
                </div>
      ...
      <div class="col-sm-4">
        <div class="box-body" style="overflow-x:auto">
          ...
          $b = json_decode($ans,true);
			...
			<a href="web_details.php?app_id=<?php echo $row["application_id"] ?>">
              <h3 class="widget-user-username text-success"><?php echo $row["application_name"] ?></h3>
              <h6 class="widget-user-desc text-danger">By <?php echo $row["user_name"] ?></h6>
			</a>
            </div>
            <div class="widget-user-image">
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-sm-4">
                <a href="pending_product.php?ver=<?php echo $row['application_id']; ?>&table=application">
                  <div class="description-block">
                    <h5 class="description-header">Verify this Application</h5>
                  </div>
                  </a>
                  <!-- /.description-block -->
                </div>
