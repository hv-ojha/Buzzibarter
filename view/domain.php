...
<div class="slide-container">
    <div class="dashboard-content">
		<div class="holder">
			<div class="top-part"><strong>My Domains</strong><i class="fa fa-list"></i></div>
			<?php
			...
			<div class="my-listing">
                <div class="row">
					<div class="col-sm-6">
						<div class="short-div">
							<h3><strong><?php echo $row["domain_name"] ?><?php if($row["verified"]=="Verified"){ ?><i class="fa fa-check-circle-o text-success"></i><?php } else{ ?>
						...
						<div class="short-div">
							<strong>Domain Topic: &nbsp;</strong><?php echo $row["domain_topic"]; ?>
						</div>
						<div class="short-div">
					...
					<div class="col-8 btn-group-vertical  btn-group-lg">
						...
						{ ?>
							<a href="domain.php?unpub=<?php echo $row["domain_id"]; ?>" class="btn ui-btn btn-success"> <i class="fa fa-eye-slash text-light"> </i> Unpublish This Application</a>
						<?php
						}
						else 
						{
						?>
							<a href="domain.php?pub=<?php echo $row["domain_id"]; ?>" class="btn ui-btn btn-success"> <i class="fa fa-eye text-light"> </i> Publish This Application</a>
						<?php
						}
						?>
						<a href="website_update.php?dom_id=<?php echo $row['domain_id']; ?>" class="btn ui-btn btn-info"> <i class="fa fa-edit text-light"> </i> Update Website</a>
						<a href="#" class="btn ui-btn btn-danger"> <i class="fa fa-trash text-light"> </i> Delete Website</a>
						<a href="website_details.php?dom_id=<?php echo $row["domain_id"]; ?>" class="btn ui-btn btn-info"> <i class="fa fa-list text-light"> </i> View Full Details</a>
					</div>
					</div>
				</div>
            </div>
